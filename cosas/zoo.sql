 ...
 */
 ...
 create table if not exists ejempleares(
    ...
    alimentacion set ('herbívora', 'carnívora', 'insectívora', 'fructívora'),
 ...
 alter table empleados
	add column salario decimal(6,2) unsigned not null default 900;
    -- hay que darle un valor por defecto
