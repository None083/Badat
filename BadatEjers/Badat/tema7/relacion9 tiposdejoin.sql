...
/*1 Queremos obtener un listado en el que se muestren los nombres de departamento y el número 
de empleados de cada uno. Ten en cuenta que algunos departamentos no tienen empleados, 
queremos que se muestren también estos departamentos sin empleados. En este caso, el número de empleados se mostrará como null.
...
/*2 Queremos averiguar si tenemos algún departamento sin dirección, para ello queremos mostrar el 
nombre de cada departamento y el nombre del director actual, para aquellos departamentos 
que en la actualidad no tengan director, queremos mostrar el nombre del departamento y el nombre de la dirección como null.*/
...
reservada, la fecha de inicio de estancia y la duración de la misma. También queremos 
que se muestre el importe de la devolución en aquellas que hayan producido dicha devolución.*/
...
/*4 Queremos mostrar un listado de todas las casas de la zona 1 en el que se muestre 
el nombre de casa y el número de reservas que se han hecho para cada casa. Si una 
casa nunca se ha reservado, deberá aparecer en el listado.*/
...
/*6 Queremos mostrar un listado de productos organizados por categorías y el 
número de unidades vendidas. Ten en cuenta que algunos productos no se han 
vendido, en cuyo caso el número de unidades vendidas se mostrará como null.*/
...
que hay en cada categoría incluidos en dicha promoción. Ten en cuenta que hay 
algunas promociones que no incluyen productos de todas las categorías, 
en cuyo caso debe aparecer la categoría y el número de productos como null.*/
